class Lotio < Formula
  ...
  url "https://github.com/matrunchyk/lotio/archive/refs/tags/v1.1.8.tar.gz"
  ...
  sha256 "9209664af1ebc8846b22f87c3a6bbcded363e19c2bea27c2fee02a5ecc178cf3"  # Auto-updated in tap
  version "1.1.8"
  license "MIT"
  
  # Bottle (pre-built binary) - much faster than building from source
  bottle do
    root_url "https://github.com/matrunchyk/lotio/releases/download/v1.1.8"
    sha256 arm64_big_sur: "6bc2119df2c07abedc47c7fb5a5426a7c87491b3177b58e5e0fd89ecdad3d634"  # Auto-updated
  end
